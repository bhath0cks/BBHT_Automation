...
altdns -i $output/${Domain}_subdomain.txt -o data_output -w ~/tools/altdns/words.txt -r -s $output/${Domain}_altdns.txt -t 100
...
nuclei(){
	...
	cat $output/${Domain}_subdomain_AIO.txt | nuclei -t ~/nuclei-templates/ | discat -1 -u https://discord.com/api/webhooks/1003275379030634506/gS_WQ1VUs0krZTQYcIeeaIUoCZyXWxyQwidybGCxiWdk4F_M2i3XC5yhXH-00c2Pry2P
