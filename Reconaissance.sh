...
cat $output/${Domain}_probed.txt | nuclei -t ~/nuclei-templates/ | discat -1 -u https://discord.com/api/webhooks/1003275379030634506/gS_WQ1VUs0krZTQYcIeeaIUoCZyXWxyQwidybGCxiWdk4F_M2i3XC5yhXH-00c2Pry2P
