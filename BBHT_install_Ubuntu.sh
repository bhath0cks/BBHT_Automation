...
# Installing Python 3.10 and pip 3.10
...
sudo python3.10 -m pip install py-altdns
...
sudo python3.10 -m pip install spyse.py
echo "${BLUE} done ${RESET}"
echo ""
sar 1 1 >/dev/null
...
sudo python3.10 -m pip install awscli --upgrade --user
...
sudo python3.10 -m pip install -r requirements3.txt
echo "${BLUE} done${RESET}"
echo ""
sar 1 1 >/dev/null
...
sudo python3.10 -m pip install xsrfprobe
echo "${BLUE} done${RESET}"
echo ""
...
sudo python3.10 -m pip install pwncat
echo "${BLUE} done${RESET}"
echo ""
...
cd ~/tools/jexboss
sudo python3.10 -m pip install -r requires.txt
echo "${BLUE} done${RESET}"
echo ""
...
sudo python3.10 -m pip install webtech
echo "${BLUE} done${RESET}"
echo ""
...
sudo python3.10 -m pip install uro
echo "${BLUE} done${RESET}"
echo ""
sar 1 1 >/dev/null
